...
| # | Notebook | Topics |
|---|---|---|
| 1 | `Learning_NLP_Basics_01.ipynb` | Sentence splitting, Word tokenization |
| 2 | `Learning_NLP_Basics_02.ipynb` | POS tagging, Lemmatization, Stopword removal |
